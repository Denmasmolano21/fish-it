...
Paste script berikut ke executor Roblox:

```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/Denmasmolano21/fish-it/refs/heads/main/denmas.lua"))()
```

Tekan **G** untuk membuka / menutup UI.
